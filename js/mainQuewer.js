...
var MW = $("#main_wrap"),
	...
	x = 0,
	i = 0,
	clearCliInvoice = "Счет организации",
	clearCliName = "Название организации",
	allInpQue = "",
	allInpAns = "",
	wheresAdmin = "",
	timer,
...
var insert_li_que = "<li><a href='#' id='que_0'>Не&nbsp;приходят&nbsp;СМС</a></li><li><a href='#' id='que_1'>Как&nbsp;сделать&nbsp;ключ&nbsp;ЭП</a></li><li><a href='#' id='que_2'>Не&nbsp;загружается&nbsp;Java-апплет</a></li><li><a href='#' id='que_3'>Как&nbsp;войти&nbsp;в&nbsp;ИБ</a></li><li><a href='#' id='que_4'>Токен&nbsp;не&nbsp;определился</a></li><li><a href='#' id='que_5'>Ключи&nbsp;заблокированы</a></li><li><a href='#' id='que_6'>Изменить&nbsp;Заявление&nbsp;для&nbsp;СМС-П</a></li><li><a href='#' id='que_7'>Не&nbsp;пришла&nbsp;выписка&nbsp;с&nbsp;приложением</a></li><li><a href='#' id='que_8'>Не&nbsp;сходятся&nbsp;остатки&nbsp;в&nbsp;ИБ</a></li><li><a href='#' id='que_9'>Как&nbsp;настроить&nbsp;импорт/экспорт&nbsp;с&nbsp;1С</a></li><li><a href='#' id='que_10'>Не&nbsp;распечатывается&nbsp;документ&nbsp;из&nbsp;ИБ</a></li><li><a href='#' id='que_11'>Как&nbsp;сменить&nbsp;пароль&nbsp;для&nbsp;ЭП</a></li><li><a href='#' id='que_12'>Не&nbsp;правильно&nbsp;указно&nbsp;наименование&nbsp;в&nbsp;ИБ</a><li><a href='#' id='que_13'>Не&nbsp;подтягивается&nbsp;справочник&nbsp;корреспондентов</a></li><li><a href='#' id='que_14'>Что&nbsp;нужно&nbsp;установить&nbsp;перед&nbsp;началом&nbsp;работы</a></li>";

/*----------------------------Ответы--------------------------------------*/


var insert_li_ans = [];
	insert_li_ans[0] =  "<li><a class='ans' href='#'>Перезагрузить&nbsp;телефон</a></li><li><a href='#' class='ans'>Заново&nbsp;запросить&nbsp;СМС</a></li><li><a href='#' class='ans'>Почистить&nbsp;телефон&nbsp;от&nbsp;СМС</a></li><li><a href='#' class='ans'>Был&nbsp;изменен&nbsp;номер&nbsp;для&nbsp;СМС-Подтверждения</a></li>",
	insert_li_ans[1] =  "<li><a href='#' class='ans'>Инструкция&nbsp;как&nbsp;сделать&nbsp;новые&nbsp;ключи</a></li>",
	insert_li_ans[2] =  "<li><a href='#' class='ans'>Проверить&nbsp;версию&nbsp;Java</a></li><li><a href='#' class='ans'>Установить/обновить&nbsp;Java</a></li><li><a href='#' class='ans'>Почистить&nbsp;КЭШ&nbsp;Java</a></li><li><a href='#' class='ans'>Почистить&nbsp;КЭШ&nbsp;браузера</a></li><li><a href='#' class='ans'>Нажать&nbsp;клавишу&nbsp;F5</a></li>",
	insert_li_ans[3] =  "<li><a href='#' class='ans'>Инструкция&nbsp;как&nbsp;войти</a></li>",
	insert_li_ans[4] =  "<li><a href='#' class='ans'>Сменить&nbsp;порт&nbsp;токена</a></li><li><a href='#' class='ans'>Установить&nbsp;драйвер&nbsp;токена</a></li><li><a href='#' class='ans'>Переустановить&nbsp;драйвер&nbsp;токена</a></li>",
	insert_li_ans[5] =  "<li><a href='#' class='ans'>Ещё&nbsp;не&nbsp;активириванный&nbsp;клиент</a></li><li><a href='#' class='ans'>Выбрать&nbsp;рабочие&nbsp;ключи</a></li><li><a href='#' class='ans'>Сделать&nbsp;новые&nbsp;ключи</a></li><li><a href='#' class='ans'>Продлить&nbsp;полномочия&nbsp;сотрудника.&nbsp;+новые&nbsp;ключи</a></li>",
	insert_li_ans[6] =  "<li><a href='#' class='ans'>Инструкция&nbsp;где&nbsp;взять&nbsp;Заявление</a></li>",
	insert_li_ans[7] =  "<li><a href='#' class='ans'>Повторно&nbsp;отправить&nbsp;выписку</a></li>",
	insert_li_ans[8] =  "<li><a href='#' class='ans'>Выполнить&nbsp;синхранизацию</a></li>",
	insert_li_ans[9] =  "<li><a href='#' class='ans'>Инструкция&nbsp;как&nbsp;настроить</a></li>",
	insert_li_ans[10] =  "<li><a href='#' class='ans'>Очистить&nbsp;КЭШ&nbsp;Java</a></li>",
	insert_li_ans[11] =  "<li><a href='#' class='ans'>Инструкция&nbsp;как&nbsp;сменить</a></li>",
	insert_li_ans[12] =  "<li><a href='#' class='ans'>Изменить&nbsp;в&nbsp;соответствии&nbsp;с&nbsp;ОДБ</a></li>",
	insert_li_ans[13] =  "<li><a href='#' class='ans'>Известная&nbsp;проблема,&nbsp;работы&nbsp;ведутся</a></li>",
	insert_li_ans[14] =  "<li><a href='#' class='ans'>Инструкция,&nbsp;что&nbsp;нужно&nbsp;установить</a></li>";
...
function ajax_all_cli_info()
	{
		var inpCliName = $("#client_name").val(),
			inpCliInvoice = $("#client_invoice").val(),
			inpContName = $("#cont_name").val(),
			inpContPhone = $("#cont_phone").val(),
			inpCallTime = $("#call_time").val(),
			inpPassedTime = $("#passed_time").val(),
			inpEndCallTime = $("#end_call_time").val(),
			inpAdmin = wheresAdmin;
...
MW.on("click", "#que_0", function(){
	make_question(this, insert_li_ans[0]);
});
MW.on("click", "#que_1", function(){
	make_question(this, insert_li_ans[1]);
});
MW.on("click", "#que_2", function(){
	make_question(this, insert_li_ans[2]);
});
MW.on("click", "#que_3", function(){
	make_question(this, insert_li_ans[3]);
});
MW.on("click", "#que_4", function(){
	make_question(this, insert_li_ans[4]);
});
MW.on("click", "#que_5", function(){
	make_question(this, insert_li_ans[5]);
});
MW.on("click", "#que_6", function(){
	make_question(this, insert_li_ans[6]);
});
MW.on("click", "#que_7", function(){
	make_question(this, insert_li_ans[7]);
});
MW.on("click", "#que_8", function(){
	make_question(this, insert_li_ans[8]);
});
MW.on("click", "#que_9", function(){
	make_question(this, insert_li_ans[9]);
});
MW.on("click", "#que_10", function(){
	make_question(this, insert_li_ans[10]);
});
MW.on("click", "#que_11", function(){
	make_question(this, insert_li_ans[11]);
});
MW.on("click", "#que_12", function(){
	make_question(this, insert_li_ans[12]);
});
MW.on("click", "#que_13", function(){
	make_question(this, insert_li_ans[13]);
});
MW.on("click", "#que_14", function(){
	make_question(this, insert_li_ans[14]);
});
